...
export function registerSlashMenu(): void {
  slashRegistry.register([
    ...
    { id: 'note-view.slash.p', label: 'Paragraph', command: 'text-editing.slash-turn-paragraph',
      keywords: ['p', 'paragraph', 'text', 'plain'], view: VIEW, scope: 'global', order: 10 },
    { id: 'note-view.slash.h1', label: 'Heading 1', command: 'text-editing.slash-turn-h1',
      keywords: ['h1', 'heading', 'title', 'header'], view: VIEW, scope: 'global', order: 20 },
    { id: 'note-view.slash.h2', label: 'Heading 2', command: 'text-editing.slash-turn-h2',
      keywords: ['h2', 'heading', 'header'], view: VIEW, scope: 'global', order: 30 },
    { id: 'note-view.slash.h3', label: 'Heading 3', command: 'text-editing.slash-turn-h3',
      keywords: ['h3', 'heading', 'header'], view: VIEW, scope: 'global', order: 40 },
    { id: 'note-view.slash.bullet', label: 'Bullet List', command: 'text-editing.slash-turn-bullet',
      keywords: ['bullet', 'ul', 'list', 'unordered'], view: VIEW, scope: 'global', order: 50 },
    { id: 'note-view.slash.ordered', label: 'Numbered List', command: 'text-editing.slash-turn-ordered',
      keywords: ['ordered', 'ol', 'list', 'number'], view: VIEW, scope: 'global', order: 60 },
    { id: 'note-view.slash.task', label: 'Task List', command: 'text-editing.slash-turn-task',
      keywords: ['task', 'todo', 'checkbox', 'check'], view: VIEW, scope: 'global', order: 70 },
    { id: 'note-view.slash.quote', label: 'Quote', command: 'text-editing.slash-turn-quote',
      keywords: ['quote', 'blockquote'], view: VIEW, scope: 'global', order: 80 },
    { id: 'note-view.slash.code', label: 'Code Block', command: 'text-editing.slash-turn-code',
      keywords: ['code', 'codeblock', 'pre'], view: VIEW, scope: 'global', order: 90 },
    { id: 'note-view.slash.divider', label: 'Divider', command: 'text-editing.slash-turn-divider',
      keywords: ['divider', 'hr', 'horizontal', 'rule', 'separator'], view: VIEW, scope: 'global', order: 100 },
    { id: 'note-view.slash.callout', label: 'Callout', command: 'text-editing.slash-turn-callout',
      keywords: ['callout', 'tip', 'warning', 'note', 'admonition'], view: VIEW, scope: 'global', order: 110 },
    { id: 'note-view.slash.toggle', label: 'Toggle List', command: 'text-editing.slash-turn-toggle',
    ...
    { id: 'note-view.slash.math-block', label: 'Math Block', command: 'text-editing.slash-insert-math-block',
