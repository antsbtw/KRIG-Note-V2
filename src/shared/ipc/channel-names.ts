...
export const IPC_CHANNELS = {
  ...
  // L5-G7:系统字体导入(L5-G7b 记名方案:只记 family 名,本机渲染 / 导出按名实时读 buffer)
  ...
  FONT_EMBED: 'font.embed',               // [L5-G7b 废弃,commit 2 删] renderer → main invoke({ path, fontIndex }) → 嵌入 → { fontId, fontUrl, ... }
