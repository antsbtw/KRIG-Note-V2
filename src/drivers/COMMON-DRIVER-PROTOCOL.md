...
>
> 文档版本:v0.2.2(P2 复审同步:剩余 v0.4 残留 + 架构图 note-pm 残留全清)
> 编写日期:2026-05-05
...
│   ├── undo-scope.ts            (注册 view 给的 scope,如 'note-view.pm';铁律 6b)
...
### 4.3 driver 不暴露 capability 的功能(v0.2 强化)
...
| 2026-05-05 | v0.2.2 | **AI 复审 P1 残留闭环**(无协议变更): 第 492 行剩余 "v0.4 强化" 残留 → "v0.2 强化";架构图 § 1.2 第 146 行 `'note-pm' scope` 注释 → `view 给的 scope,如 'note-view.pm';铁律 6b`(消除架构图跟铁律 6b 的视觉冲突)。 |
