...
// ═══════════════════════════════════════════════════════
// §1  InsertStep 类型——已下沉到 shared/ipc/article-plan-types，从那里 re-export
// ═══════════════════════════════════════════════════════
...
export type {
  ...
  ArticleInsertStep,
  ArticlePlan,
} from '@shared/ipc/article-plan-types';

import type { ArticleInsertStep, ArticlePlan } from '@shared/ipc/article-plan-types';
