...
| 28 | L5-B3.16 | **Phase B5 媒体三兄弟收齐**:audioBlock(<audio> + 上传 + 下载)+ videoBlock(YouTube embed iframe / 直接 video,砍字幕系统留 D / 砍 Vimeo+generic 留 D);driver 抽 insertWithCaptionBlock 通用辅助 — image / audio / video 三个 insert API 共用 | (待 merge) | 2026-05-08 |
