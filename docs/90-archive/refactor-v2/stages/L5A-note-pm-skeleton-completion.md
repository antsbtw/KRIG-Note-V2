...
| 文件 | 内容 |
|---|---|
| `docs/90-archive/refactor-v2/research/V1-function-mapping.md` v0.2 | V1 笔记功能 → V2 capability 双轴映射(作用域 × 功能类型);capability 边界讨论的输入材料 |
| `docs/90-archive/refactor-v2/research/V1-block-operations.md` v0.2 | V1 block 操作汇总(20+ 种);BlockSpec 设计输入(containerRule / cascadeBoundary 两个布尔字段的来源) |
