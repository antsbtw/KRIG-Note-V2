...
| 改动 | 位置 |
|---|---|
| 加 3 predicate 到 relations vocab 登记 | `docs/90-archive/refactor-v2/data-model/relations/spec.md` §10 |
...
verify 完毕产出 `block-atomization-test-report.md`(放 `docs/90-archive/refactor-v2/notes/`)。
