...
V2 持久化层。详 [`docs/90-archive/refactor-v2/data-model/persistence/`](../../docs/90-archive/refactor-v2/data-model/persistence/) 完整规范。
...
按 [decision 008 §4.0](../../docs/90-archive/refactor-v2/data-model/persistence/decisions/008-storage-layer-interface.md):
