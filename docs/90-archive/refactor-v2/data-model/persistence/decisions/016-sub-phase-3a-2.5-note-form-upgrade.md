...
**vocab 登记**(`docs/90-archive/refactor-v2/data-model/relations/spec.md §10`):
```markdown
...
- `docs/90-archive/refactor-v2/data-model/relations/spec.md`:§10 vocab 登记表加 hasNoteView 一行
...
**改 1**: `docs/90-archive/refactor-v2/data-model/relations/spec.md §10` 表格加一行:
```markdown
| `user:krig:hasNoteView` | pm | literal `bool` (value 恒 true) | 一对一 | sub-phase 3a-2.5 | [decision 016](...) |
```
...
**verify**:
- `grep -rn "hasNoteView" src/ docs/90-archive/refactor-v2/data-model/` 字面已登记
- typecheck 0 error
