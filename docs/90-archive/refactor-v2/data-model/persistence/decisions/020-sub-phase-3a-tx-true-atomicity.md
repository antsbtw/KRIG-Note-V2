...
- ✅ **必须新增** `docs/90-archive/refactor-v2/data-model/persistence/SDK-version-binding-policy.md` 永久文档(参 §4.4)
...
2. **跨子阶段永久规则层** — **新建** [`docs/90-archive/refactor-v2/data-model/persistence/SDK-version-binding-policy.md`](../SDK-version-binding-policy.md)(独立永久文档,跨 sub-phase 复用,避免未来再丢纪律)
...
- 新建 `docs/90-archive/refactor-v2/data-model/persistence/SDK-version-binding-policy.md`(必须新增)
...
| `docs/90-archive/refactor-v2/notes/L7-next-phase-kickoff.md` | §1.4 Q-tx + §6.2 | 改"已解决",移除"3.x 待查"误导;§2.1 sub-phase 3a-tx ✅ |
| **`docs/90-archive/refactor-v2/data-model/persistence/SDK-version-binding-policy.md`** | **新建** | **独立永久文档(用户 P1 硬性,非可选)**,骨架见 §4.4 |
