...
| 文件 | 状态 | 内容 |
|---|---|---|
| `docs/90-archive/refactor-v2/thought-view-port.md` | **本文档** | v0.4 设计 |
| `docs/90-archive/refactor-v2/test-checklists/thought-view-test.md` | **新增**（Phase 5 前） | ≥ 30 项（含 ebook source） |
...
详见独立文件 `docs/90-archive/refactor-v2/test-checklists/thought-view-test.md`（Phase 1 完工后创建）。预览：
