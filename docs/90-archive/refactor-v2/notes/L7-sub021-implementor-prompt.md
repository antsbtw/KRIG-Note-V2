...
按 `docs/90-archive/refactor-v2/data-model/persistence/decisions/021-sub-phase-021-folder-view-isolation.md`(状态 🟢 finalize v0.3,merge 03aab55)执行 sub-phase 021:
