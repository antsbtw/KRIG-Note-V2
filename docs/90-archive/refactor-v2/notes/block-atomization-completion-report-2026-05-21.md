...
| `docs/90-archive/refactor-v2/data-model/relations/spec.md` | §10 追加 3 predicate + §10.2 节语义解释 |
| `docs/90-archive/refactor-v2/data-model/atom/spec.md` | §2.5.1 L7 反向更新 |
| `docs/90-archive/refactor-v2/data-model/persistence/decisions/022-sub-phase-022-ebook-thought-migration.md` | §3.2 "decision 030+" 占位注销 → decision 026 |
| `docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md` | §10.1 NoteLocator preview 字段扩展 |
