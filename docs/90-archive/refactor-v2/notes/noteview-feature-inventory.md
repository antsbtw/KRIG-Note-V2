...
> 来源:`docs/90-archive/refactor-v2/stages/L5A*` ~ `L5B3.20*` 全部完成报告 + `src/views/note/` 当前代码扫描。
...
5. **不在本表里的 V1 老功能**(toolbar / 阅读位置 / AI sync 等业务横切),归 docs/90-archive/refactor-v2/v1-note-migration-audit.md 管,不混进来
