...
1. **本对话上下文文档**(必读):
   - `docs/90-archive/refactor-v2/notes/L7-next-phase-kickoff.md`(本启动包,含本 prompt + 实施者 prompt 模板 + 启动检查清单)

2. **设计师纪律 + 累积教训**(必读):
   - `docs/90-archive/refactor-v2/data-model/persistence/decisions/013-sub-phase-3a-graph-canvas-migration.md` §0.5(5 次 P1 教训累积纪律)
   - `docs/90-archive/refactor-v2/data-model/persistence/decisions/014-sub-phase-3a-1-graph-canvas-instance-migration.md` §12(实施实际情况 + 偏离登记 + 事故 + 教训)
...
4. **总规范基线**(随时查阅):
   - `docs/90-archive/refactor-v2/data-model/atom/spec.md`(atom domain 体系)
   - `docs/90-archive/refactor-v2/data-model/relations/spec.md`(边一等公民 + krig vocab 登记表 §10)
   - `docs/90-archive/refactor-v2/data-model/persistence/decisions/008-storage-layer-interface.md`(view/capability/storage 调用边界)
   - `docs/90-archive/refactor-v2/data-model/persistence/decisions/009-migration-strategy.md`(sub-phase 拆分进度)
...
1. 读 `docs/90-archive/refactor-v2/notes/L7-next-phase-kickoff.md`(本启动包)
...
按 `docs/90-archive/refactor-v2/data-model/persistence/decisions/{{XXX-decision-filename}}.md` 决议文档执行 {{sub-phase 简述}}。
...
```bash
# 必读文档存在
ls docs/90-archive/refactor-v2/notes/L7-next-phase-kickoff.md
ls docs/90-archive/refactor-v2/data-model/persistence/decisions/013-sub-phase-3a-graph-canvas-migration.md
ls docs/90-archive/refactor-v2/data-model/persistence/decisions/014-sub-phase-3a-1-graph-canvas-instance-migration.md
```
