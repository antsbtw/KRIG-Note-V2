...
按 `docs/90-archive/refactor-v2/data-model/persistence/decisions/022-sub-phase-022-ebook-thought-migration.md`(状态 🟢 finalize v0.4,merge 91cfbf8)执行 sub-phase 022:
