...
> **触发日期**:2026-05-21
> **前置依赖**:
>   - [`docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md`](../RefactorV2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md)(承接 v1.3 工程妥协)
>   - [`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`](../RefactorV2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md)(核心设计 14 节)
>   - [`docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md`](../RefactorV2/stages/block-atomization-implementation-plan.md)(9 Stage 实施计划)
...
- 完成验收报告写在 `docs/90-archive/refactor-v2/notes/block-atomization-completion-report-<YYYY-MM-DD>.md`
- 用户审计通过后合 main
...
1. **`docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md`** — 9 Stage 完整任务设计(这是你的工作手册)
2. **`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`** — 14 节核心设计;
...
3. **`docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md`** — 工程妥协承接条款 + 反向更新清单(decision 022 §3.2 占位等)

### 2.2 上下文文档

4. **`docs/90-archive/refactor-v2/notes/atom-granularity-investigation-2026-05-21.md`** — 调查报告(理解触发背景)
...
7. **`docs/90-archive/refactor-v2/data-model/persistence/decisions/012-sub-phase-2-note-folder-migration.md`** — 学 sub-phase 实施 commit 节奏
8. **`docs/90-archive/refactor-v2/data-model/persistence/decisions/013-sub-phase-3a-graph-canvas-migration.md`** — graph-instance 细颗粒 atom 模式(本 sub-phase 直接对照)
9. **`docs/90-archive/refactor-v2/data-model/persistence/decisions/022-sub-phase-022-ebook-thought-migration.md`** — sub-phase 实施完整流程参照(含审计与反向更新)
10. **`docs/90-archive/refactor-v2/data-model/persistence/spec.md`** + `atom-entity.md` + `edge-entity.md` + `surreal-schema.md` — storage 层契约
...
- 实施期间若发现**字面证据**跟决议 026 不一致(如 PM schema 关系 / storage API 行为):
  ...
  3. 写入 `docs/90-archive/refactor-v2/notes/block-atomization-deviations-<YYYY-MM-DD>.md`
  4. 完成报告时汇总
- 偏离类型:
...
- ✅ 偏离登记(若有)归档 `docs/90-archive/refactor-v2/notes/block-atomization-deviations-<YYYY-MM-DD>.md`
- ✅ 完成报告 `docs/90-archive/refactor-v2/notes/block-atomization-completion-report-<YYYY-MM-DD>.md`
