...
最终交付物 = 一份**调查报告**（Markdown 文档），位置：`docs/90-archive/refactor-v2/notes/atom-granularity-investigation-2026-05-21.md`
...
[atom/spec.md §0](../../../docs/90-archive/refactor-v2/data-model/atom/spec.md)：
> "Atom = V2 语义层的**最小**实体"

[README.md §40-55](../../../docs/90-archive/refactor-v2/data-model/README.md)：
> "Atom 承载数据本体，按 domain 分类"
> "pm domain | ProseMirror node JSON | 用户可编辑内容（文本 / 数学 / 代码 / 列表 ...）"

[atom/spec.md §2.1 PmPayload](../../../docs/90-archive/refactor-v2/data-model/atom/spec.md)：
```ts
...
1. `docs/90-archive/refactor-v2/data-model/README.md` —— 整体框架 + Phase 历史
2. `docs/90-archive/refactor-v2/data-model/atom/spec.md` —— Atom 通用接口、§0「最小实体」、§2 pm domain 完整定义
3. `docs/90-archive/refactor-v2/data-model/atom/decisions/` 下**所有**编号决议（002 / 003 / 004 / 005...）
4. `docs/90-archive/refactor-v2/data-model/persistence/spec.md`
5. `docs/90-archive/refactor-v2/data-model/persistence/atom-entity.md`
6. `docs/90-archive/refactor-v2/data-model/persistence/edge-entity.md`
7. `docs/90-archive/refactor-v2/data-model/persistence/surreal-schema.md`
8. `docs/90-archive/refactor-v2/data-model/persistence/decisions/` 下**所有**决议（006 / 007 / 008 / 009 / 010 / 011 等）
9. `docs/90-archive/refactor-v2/data-model/relations/spec.md`
10. `docs/90-archive/refactor-v2/data-model/relations/pm-note.md` + `pm-note/blocks/` 下若干份子文档（重点看 paragraph / heading / orderedList 三个）
11. `docs/90-archive/refactor-v2/data-model/naming-conventions.md`
12. `docs/90-archive/refactor-v2/data-model/mixins/spec.md`
...
16. `docs/90-archive/refactor-v2/stages/` 下任何提到「note 迁移」「block 拆分」「atom 颗粒度」的文档
...
# 早期讨论
find docs/90-archive/refactor-v1/ docs/90-archive/refactor-v2/ -name "*.md" -exec grep -l "block.*atom\|atom.*block\|note.*粒度\|colocation" {} \; 2>/dev/null
...
输出文件：`docs/90-archive/refactor-v2/notes/atom-granularity-investigation-2026-05-21.md`
...
3. **开始阶段 1**：读 `docs/90-archive/refactor-v2/data-model/README.md`，给用户 200 字要点
