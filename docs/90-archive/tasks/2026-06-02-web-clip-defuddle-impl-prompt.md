...
**设计文档（必读，权威）**：`docs/90-archive/tasks/2026-06-01-web-clip-defuddle-design.md`（v0.2）。
...
- 当前在 `main`。**先开实施分支**：`git checkout -b feature/web-clip-defuddle`（main 上有一堆未跟踪的 docs/90-archive/tasks/*.md，
