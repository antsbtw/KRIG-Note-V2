...
### C. X 长图（note → 竖向长图发 X）
- **是什么**：整篇 note 渲成一张竖向长图发 X。设计见 `docs/90-archive/tasks/2026-06-12-x-note-to-longimage-design.md`。
...
- note→canvas 拖拽：无
- 长图设计：`docs/90-archive/tasks/2026-06-12-x-note-to-longimage-design.md`
