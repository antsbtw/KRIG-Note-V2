...
产出报告 `/Users/wenwu/Documents/VPN-Server/KRIG-Note-V2/docs/90-archive/tasks/2026-05-28-import-system-survey.md`（**不 commit、不切分支**）。
...
- 写到 `/Users/wenwu/Documents/VPN-Server/KRIG-Note-V2/docs/90-archive/tasks/2026-05-28-import-system-survey.md`（用 Write 工具，绝对路径）
