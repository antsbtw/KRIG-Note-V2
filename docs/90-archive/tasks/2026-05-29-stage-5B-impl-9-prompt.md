...
- **不要** push
- **不要** merge 到 main
- **不要** commit `docs/90-archive/tasks/2026-05-29-stage-5B-impl-7-prompt.md` / `docs/90-archive/tasks/import-progress-ui-prompt.md` 这类老 untracked
- 可以 commit 本 prompt 文档 `docs/90-archive/tasks/2026-05-29-stage-5B-impl-9-prompt.md`（与 commit 7a 同 commit）
