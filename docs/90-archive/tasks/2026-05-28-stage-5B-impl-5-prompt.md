...
1. **5B 设计 §节 3 + §节 4 Stage 5**：[`docs/90-archive/tasks/2026-05-28-stage-5B-import-converter-design.md`](2026-05-28-stage-5B-import-converter-design.md) — 节 3.3 API 契约 / 节 2 Q1 (table-adapter) / 节 4 Stage 5 字面任务清单
2. **5A 拍板汇总**：[`docs/90-archive/tasks/2026-05-28-stage-5A-decision-026-amendment-summary.md`](2026-05-28-stage-5A-decision-026-amendment-summary.md) — table 是 atom / tableRow 不是 atom 等硬契约
...
- **不要** push（保留给总指挥）
- **不要** merge 到 main
- 不要 commit 任何与 5B Stage 5 无关的文件（如 docs/90-archive/tasks/import-progress-ui-prompt.md 这类老 untracked）
