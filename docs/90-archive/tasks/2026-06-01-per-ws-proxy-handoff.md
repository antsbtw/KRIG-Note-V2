...
spike prompt:[docs/90-archive/tasks/2026-06-01-spike-per-ws-proxy-prompt.md](./2026-06-01-spike-per-ws-proxy-prompt.md)。
...
整个 web 增强的历史 prompt 都在 [docs/90-archive/tasks/](.) 下(2026-05-31-web-* 和 2026-06-01-web-*),新对话可参考既有套路(实现包格式、subagent 派发方式)。
