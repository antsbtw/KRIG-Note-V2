...
请按照 `docs/90-archive/tasks/code-block-cm6.md` 的设计实现 inline code block 接入 CodeMirror 6 capability,**Phase 1 + 2 + 3 三个阶段都做完**。
...
**`docs/90-archive/tasks/code-block-cm6.md`** 包含完整的:
- 10 个技术决议(D1-D10,已拍板)
...
1. **先读 doc**:`docs/90-archive/tasks/code-block-cm6.md` 通读,确认决议清单 + 文件结构 + V1 grep 速查表
...
开干前请回复确认:
- [ ] 我已读完 `docs/90-archive/tasks/code-block-cm6.md`,理解 10 个决议 + 3 Phase 拆分 + mermaid 兼容底线
