...
- **不要** push
- **不要** merge 到 main
- 不要 commit `docs/90-archive/tasks/import-progress-ui-prompt.md` / `2026-05-29-stage-5B-impl-7-prompt.md` 等老 untracked
- **可以** commit 本 prompt 文档 `docs/90-archive/tasks/2026-05-29-import-progress-ux-prompt.md`（与 commit a 同 commit）
