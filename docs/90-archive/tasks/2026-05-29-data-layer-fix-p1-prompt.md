...
**Audit 报告**：[`docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md`](../../docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md)，commit `006b500f`，在 `docs/data-layer-audit` 分支。
...
- **可以** commit 本 prompt 文档 `docs/90-archive/tasks/2026-05-29-data-layer-fix-p1-prompt.md`（与 commit a 同 commit）
