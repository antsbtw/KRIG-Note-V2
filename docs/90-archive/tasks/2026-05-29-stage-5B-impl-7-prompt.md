...
1. **5B 设计 §节 4 Stage 7 + §7.5.2**：[`docs/90-archive/tasks/2026-05-28-stage-5B-import-converter-design.md`](2026-05-28-stage-5B-import-converter-design.md) — 了解 batch API 原意；本期实施不按 §7.5.2 字面，按本 prompt §"用户拍板"
...
- **不要** push
- **不要** merge 到 main
- 不要 commit 任何与 5B Stage 7 无关的文件（如 `docs/90-archive/tasks/import-progress-ui-prompt.md`）
