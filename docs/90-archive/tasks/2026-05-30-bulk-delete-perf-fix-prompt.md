...
3. 读 [diagnose 报告 docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md](docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md)(diagnose/bulk-delete-perf 分支,**不在 main**,用 `git show diagnose/bulk-delete-perf:docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md` 提取读)
...
```bash
git show diagnose/bulk-delete-perf:docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md
```

或:

```bash
git checkout diagnose/bulk-delete-perf -- docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md
# 读完后:git checkout HEAD -- docs/90-archive/tasks/2026-05-30-bulk-delete-perf-diagnose-report.md(还原 main 干净)
```
