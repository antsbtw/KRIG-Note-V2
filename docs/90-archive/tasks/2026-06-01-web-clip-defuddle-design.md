...
> - 分层/注册基准：`docs/00-architecture/charter.md` §1.1/§1.2/§1.3/§1.4 + §3.2、`docs/90-archive/refactor-v2/audit/2026-05-08-register-and-layer-audit.md`
...
- 严格态定义：`docs/90-archive/refactor-v2/audit/2026-05-08-register-and-layer-audit.md`
