...
**字面唯一产出**：一份**报告文档** [`docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md`](../../docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md)（新建）
...
字面新建 [`docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md`](../../docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md)，字面结构：
...
```bash
cd /Users/wenwu/Documents/VPN-Server/KRIG-Note-V2 && git add docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md docs/90-archive/tasks/2026-05-29-data-layer-audit-prompt.md && git commit -m "..."
```
...
- `Read` 任何 src/ 文件
- `Write` 字面新建 `docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md`
