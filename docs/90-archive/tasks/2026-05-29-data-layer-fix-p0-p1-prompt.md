...
**Audit 报告**是前置工作：[`docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md`](../../docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md)，commit `006b500f`，在 `docs/data-layer-audit` 分支。
...
```bash
cd /Users/wenwu/Documents/VPN-Server/KRIG-Note-V2 && git show docs/data-layer-audit:docs/90-archive/tasks/2026-05-29-data-layer-audit-report.md > /tmp/audit-report.md && wc -l /tmp/audit-report.md
```
...
- **可以** commit 本 prompt 文档 `docs/90-archive/tasks/2026-05-29-data-layer-fix-p0-p1-prompt.md`（与 commit a 同 commit）
