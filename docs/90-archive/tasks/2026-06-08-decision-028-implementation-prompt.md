...
1. **架构决策（权威方案）**：
   `docs/90-archive/refactor-v2/data-model/persistence/decisions/028-block-structure-via-attrs.md`
   —— 这是本任务的**唯一权威设计**。所有实现以它为准。
2. **被修订的旧设计**：
   `docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`
