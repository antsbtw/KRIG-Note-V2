...
> **触发日期**：2026-05-21
> **触发依据**：[docs/90-archive/refactor-v2/notes/atom-granularity-investigation-2026-05-21.md](../RefactorV2/notes/atom-granularity-investigation-2026-05-21.md) 调查报告
...
[`docs/90-archive/refactor-v2/notes/atom-granularity-investigation-2026-05-21.md`](../RefactorV2/notes/atom-granularity-investigation-2026-05-21.md) —— 全文读完。
...
1. [`docs/90-archive/refactor-v2/data-model/atom/spec.md`](../RefactorV2/data-model/atom/spec.md) §0 / §1 / §2 —— atom 字面定义
2. [`docs/90-archive/refactor-v2/data-model/atom/decisions/`](../RefactorV2/data-model/atom/decisions/) 所有 002-005 决议 —— 学决议文档结构
3. [`docs/90-archive/refactor-v2/data-model/persistence/decisions/`](../RefactorV2/data-model/persistence/decisions/) 011-024 决议 —— 重点：
...
**产出 1**：`docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md`（编号按现有最高 +1，先 grep 确认）
...
**产出 2**：`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`（编号 grep 确认）
...
**产出 3**：`docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md`
...
| # | 文件 | 性质 |
|---|------|------|
| 1 | `docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md` | 承接 v1.3 工程妥协 + 注销 decision 030 占位 |
| 2 | `docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md` | 核心决议 |
| 3 | `docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md` | 实施任务设计 |

**编号**：动手前先 `ls docs/90-archive/refactor-v2/data-model/atom/decisions/` 和 `ls docs/90-archive/refactor-v2/data-model/persistence/decisions/` 确认现有最大编号，自动递增。
