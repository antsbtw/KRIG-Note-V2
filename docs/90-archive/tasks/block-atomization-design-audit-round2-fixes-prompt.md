...
> **前置文档**:
> - [`docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md`](../RefactorV2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md)
> - [`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`](../RefactorV2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md)
> - [`docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md`](../RefactorV2/stages/block-atomization-implementation-plan.md)
...
1. [`docs/90-archive/refactor-v2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md`](../RefactorV2/data-model/atom/decisions/025-atom-granularity-current-form-acknowledgment.md)(290 行)
2. [`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`](../RefactorV2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md)(867 行)
3. [`docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md`](../RefactorV2/stages/block-atomization-implementation-plan.md)(965 行)
...
```bash
grep -n "^### 3\." docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md
```
...
grep -n "24+ blocks\|24 blocks\|24+ block" docs/90-archive/refactor-v2/

# 2. blockquote 应只在叶子级容器位置出现(不再算"叶子文本块")
grep -n "blockquote" docs/90-archive/refactor-v2/data-model/persistence/decisions/026*.md docs/90-archive/refactor-v2/stages/block-atomization-implementation-plan.md

# 3. §3 节号检查(应不再有 §3.3 重复)
grep -nE "^### 3\." docs/90-archive/refactor-v2/data-model/persistence/decisions/026*.md

# 4. 方案 B 拍板残留(应已改为方案 D)
grep -n "方案 B\|方案 D\|拍板:.*B\|拍板:.*D" docs/90-archive/refactor-v2/data-model/persistence/decisions/026*.md

# 5. Open Questions 计数(应新增 13.7 + 13.8 共 8 个)
grep -nE "^### 13\." docs/90-archive/refactor-v2/data-model/persistence/decisions/026*.md

# 6. 风险表行数(应新增 undo merge 风险一行)
grep -c "^|" docs/90-archive/refactor-v2/data-model/persistence/decisions/026*.md  # 表格行变化前后对比
```
