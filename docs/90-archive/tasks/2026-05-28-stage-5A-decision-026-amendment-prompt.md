...
你不写源代码，**但你可以修改决议文档**（`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`）—— 决议文档**就是**你这个阶段要拍板的对象。
...
- 必读输入文档：
  1. **调研报告**：`docs/90-archive/tasks/2026-05-28-import-system-survey.md` — 重点读节 4.1 / 4.6 / 节 5 / 节 7.2 / 节 7.6
  2. **决议 026 原文**：`docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md` — 通读，重点 §3.1 / §3.4 / §6.1 / §13
...
直接修改 `docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`，使其与"table 是 atom"决策**字面对齐**、内部不再矛盾。
...
新建 `docs/90-archive/tasks/2026-05-28-stage-5A-decision-026-amendment-summary.md`（**不超过 400 行**），写：
...
- 你**可以**编辑 `docs/90-archive/refactor-v2/data-model/persistence/decisions/026-block-atomization-sub-phase-design.md`（决议文档）
- 你**可以**新建 `docs/90-archive/tasks/2026-05-28-stage-5A-decision-026-amendment-summary.md`
- 你**不可以**:
  - 修改 `src/` 任何源代码
...
- 汇总文档已写入 `docs/90-archive/tasks/2026-05-28-stage-5A-decision-026-amendment-summary.md`（≤400 行）
