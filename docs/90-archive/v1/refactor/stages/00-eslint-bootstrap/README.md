...
| 文件 | 角色 |
|------|------|
| [docs/90-archive/refactor-v1/00-总纲.md](../../00-总纲.md) v2.3 | 全员必读 |
...
`docs/90-archive/refactor-v1/stages/01-contracts/`（波次 1：项目规则定义）—— 本阶段 merge 到 main 后重启 01。01 阶段 task-card 不变，但 Builder 重启时仓库已具备 ESLint 工具链，J5 系列判据将不再 BLOCKING。
