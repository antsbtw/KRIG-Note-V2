...
## 引用
- 总纲：[docs/90-archive/refactor-v1/00-总纲.md](../../00-总纲.md) v2.3 § 2 推进节奏 / § 5 View-scoped Registry / § 7 三角架构
...
详见 [docs/90-archive/refactor-v1/00-总纲.md](../../docs/90-archive/refactor-v1/00-总纲.md):
