...
**任务卡**：`docs/90-archive/refactor-v1/stages/01-contracts/task-card.md`（v4 修订版，commit `929ac1f9`）
**契约**：N/A（基础设施类子波次）
**HEAD**：`71f8bcda`
...
```
$ git diff ca598c7a..HEAD --stat | grep -v docs/90-archive/refactor-v1/stages/01-contracts
 CLAUDE.md                                          |  15 +++
