...
**任务卡**：`docs/90-archive/refactor-v1/stages/00x-schema-completion/task-card.md`
...
```
docs/90-archive/refactor-v1/stages/00x-schema-completion/AUDITOR-INSTRUCTION.md   (新增)
docs/90-archive/refactor-v1/stages/00x-schema-completion/BUILDER-INSTRUCTION.md   (新增)
docs/90-archive/refactor-v1/stages/00x-schema-completion/README.md                (新增)
docs/90-archive/refactor-v1/stages/00x-schema-completion/task-card.md             (新增)
```
