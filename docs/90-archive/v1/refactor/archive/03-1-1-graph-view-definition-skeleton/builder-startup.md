...
- ✅ 总纲 v2.3
- ✅ CLAUDE.md（重构期硬规则段）
- ✅ refactor-card：`docs/90-archive/refactor-v1/stages/03-1-1-graph-view-definition-skeleton/task-card.md`
- ✅ 阶段说明与执行指令：`docs/90-archive/refactor-v1/stages/03-1-1-graph-view-definition-skeleton/README.md`、`docs/90-archive/refactor-v1/stages/03-1-1-graph-view-definition-skeleton/BUILDER-INSTRUCTION.md`
- ✅ 功能契约：N/A（基础设施类阶段）
