...
```
docs/90-archive/refactor-v1/stages/02a-platform-skeleton/AUDITOR-INSTRUCTION.md   ← Commander 派活 commit 0f73f53e
docs/90-archive/refactor-v1/stages/02a-platform-skeleton/BUILDER-INSTRUCTION.md   ← 同上
docs/90-archive/refactor-v1/stages/02a-platform-skeleton/README.md                ← 同上
docs/90-archive/refactor-v1/stages/02a-platform-skeleton/task-card.md             ← 同上
