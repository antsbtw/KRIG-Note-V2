...
1. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/00-总纲.md`
   —— 项目宪法，所有规则的最高来源

2. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/CLAUDE.md`
   —— 项目根 CLAUDE.md，含重构期硬规则段

3. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/migration-contracts/<本次审计的插件>.md`
...
**功能契约**：docs/90-archive/refactor-v1/migration-contracts/<plugin>.md（已读）
**总纲版本**：v2.x
