...
1. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/00-总纲.md` —— 项目宪法
2. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/CLAUDE.md` —— 项目规范
3. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/COMMANDER-PROMPT.md` —— 本文件
4. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/BUILDER-PROMPT.md` —— 你要派活的对象的纪律
5. `/Users/wenwu/Documents/VPN-Server/KRIG-Note/docs/90-archive/refactor-v1/AUDITOR-PROMPT.md` —— 同上
...
[1] 准备：起草 refactor-card + 启动指令
    ...
    ├─ 起草 docs/90-archive/refactor-v1/cards/refactor-<分支名>.md
...
每个重构阶段一个独立目录 `docs/90-archive/refactor-v1/stages/<NN>-<阶段名>/`，包含：

```
docs/90-archive/refactor-v1/stages/01-contracts/
...
## 引用
- 总纲：docs/90-archive/refactor-v1/00-总纲.md v<X.Y>
- 功能契约：docs/90-archive/refactor-v1/migration-contracts/<plugin>.md v<X.Y>
...
| 阶段目录 | `docs/90-archive/refactor-v1/stages/<NN>-<阶段名>/`（永久保留：README + task-card + BUILDER-INSTRUCTION + AUDITOR-INSTRUCTION） |
| 本会话工作记录 | 不写文件，写入聊天即可 |
