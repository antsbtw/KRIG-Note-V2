...
> v0.1 · 2026-05-25
> 配套提示词:`docs/90-archive/refactor-v1/pdf-viewer-adapter-prompt.md`
...
写 `docs/90-archive/refactor-v1/pdf-viewer-adapter-test-checklist.md`(逐项"操作 → 期望"格式):
- 加载 / 翻页 / 滚动
- trackpad pinch 缩放体验
- Cmd+= / Cmd+- / Cmd+0
- outline 跳转
...
- [x] Stage 5 — 测试清单 `docs/90-archive/refactor-v1/pdf-viewer-adapter-test-checklist.md`
